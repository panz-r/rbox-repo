...
| F | Category Isolation | SAFE, NETWORK isolation tests |
...
| T | Category Isolation | CAUTION, BUILD, CONTAINER isolation tests |
| U | Category Isolation | MODIFYING, DANGEROUS, ADMIN isolation tests |
