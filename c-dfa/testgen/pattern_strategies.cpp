...
// ============================================================================
//
// This file contains all pattern generation strategy implementations.
//
// Contents:
// - 30 try* strategy functions
// - applyEdgeCases post-processing function
//
// Validation helpers and factory functions are in validation_helpers.cpp
...
// Note: [[...]] is FRAGMENT_REF syntax, so we use single parens for grouping only
...
PatternResult tryTripleQuant(const std::vector<std::string>& matching,
    ...
    // Try: (base)?+ (optional base, then plus)
